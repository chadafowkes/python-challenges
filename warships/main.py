...
def GetRowColumn():
  print()
  coordsInput = input("Please enter coords: ")
  Row = int(coordsInput[0])
  Column = int(coordsInput[1])
  print()
  return Row, Column
...
def PlayGame(Board, Ships):
  ...
  while not GameWon:
    ...
    if GameWon:
      print("All ships sunk! It took you", Moves, "many moves.")
      print()
...
if __name__ == "__main__":
  ...
  while not MenuOption == 9:
    Board = SetUpBoard()
    Ships = [["Aircraft Carrier", 5], ["Battleship", 4], ["Submarine", 3], ["Destroyer", 3], ["Patrol Boat", 2], ["Raft", 1]]
    DisplayMenu()
